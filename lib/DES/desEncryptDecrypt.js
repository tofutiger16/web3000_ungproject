...
function des() {
    ...
    let validData = validInput(inputText, passphrase);
...
function validInput(inputData, inputKey) {
    let checkValid = true;
    ...
    if (inputKey > 128) {
        checkValid = false;
        alert("Passphrase entered in to long please keep it under 128 characters.");
    }
